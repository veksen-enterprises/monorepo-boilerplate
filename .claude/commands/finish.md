...
7. **Scope check:** Confirm the diff contains ONLY task-related changes. Revert unrelated hunks (including stray formatter reflows).
8. **Rebase:**
...
9. **Post-rebase:** Re-run tests, lint, format, check-types, build. All must pass.
10. **Summary:** Report what was done, what tests cover it, and any caveats.
